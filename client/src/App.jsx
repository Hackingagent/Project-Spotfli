...
import ManageService from "./components/views/service-provider/manage-service/ManageService";
    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          />
          {/* Manage hotel routes */}
          <Route path="/manage-hotel" element={<HotelDashboard />}>
            {" "}
          </Route>
          ...
          <Route path="/admin">
            ...
            <Route element={<AdminLayout />}>
              ...
              <Route
                path="service-provider/pending"
                element={<AdminPendingProvider />}
              />
              <Route
                path="service-provider/approved"
                element={<AdminApprovedProvider />}
              />
              <Route
                path="service-provider/declined"
                element={<AdminDeclinedProvider />}
              />
          ...
          <Route path="/service-provider">
            <Route element={<ServiceProviderLayout />}>
              ...
              <Route path="my-service" element={<MyServices />} />
